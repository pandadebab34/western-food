...
public class NewOrder extends JFrame {
	...
	public NewOrder(String orderid) throws IOException {
		...
		custnamefield.setBackground(UIManager.getColor("Button.light"));
		custnamefield.setColumns(10);

		JTextField phonenofield = new JTextField();
		phonenofield.setBackground(UIManager.getColor("Button.light"));
		...
		regularcustomercheck.setBackground(UIManager.getColor("Button.light"));
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panel.createSequentialGroup()
					...
					.addComponent(lblNewLabel_2, GroupLayout.PREFERRED_SIZE, 312, GroupLayout.PREFERRED_SIZE)
					.addGap(307))
		);
